...
def test_record_and_resolve_decision():
    ...
    pnl_tracker.tick_pnl(y=100, k=100, decision=1)
    ...
    pnl_tracker.tick_pnl(y=150, k=100, decision=0)  # No new decision
...
def test_multiple_decisions_over_time():
    ...
    pnl_tracker.tick_pnl(y=120, k=50, decision=0)
    ...
    pnl_tracker.simplepnl["current_ndx"] = 100
    pnl_tracker.tick_pnl(y=150, k=100, decision=0)
...
def test_sequential_resolutions_with_no_decision():
    ...
    pnl_tracker.simplepnl["current_ndx"] = 150
    pnl_tracker.tick_pnl(y=160, k=50, decision=0)  # No new decision
